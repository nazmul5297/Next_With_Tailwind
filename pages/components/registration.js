...
export function Registration() {
  return (
    <>
      <div className="w-full h-full flex flex-col bg-slate-600 overflow-hidden">
        <div className="w-full h-auto  bg-gray-300 flex overflow-hidden">
          <div className=" h-96 w-11/12 bg-gray-50 mx-auto mt-12 mb-12 rounded shadow flex flex-col overflow-hidden">
